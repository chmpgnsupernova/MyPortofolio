const Hero = () => {
  const data = {
    ...
    links: { 
      // Ganti username github lo disini kalau perlu
    ...
    <section className="min-h-screen flex flex-col justify-center items-center text-center px-6 pt-20">
      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-12 w-full sm:w-auto animate-in slide-in-from-bottom-8 duration-1000">
        <a 
          ...
          className="flex items-center justify-center gap-2 bg-accent text-black px-8 py-3 rounded-lg font-bold hover:bg-green-400 transition-all hover:scale-105 shadow-[0_0_15px_rgba(34,197,94,0.4)]"
        >
          Contact Me
        </a>
        ...
        <a 
          ...
          target="_blank" 
          rel="noopener noreferrer"
          className="flex items-center justify-center gap-2 bg-transparent border border-border text-white px-8 py-3 rounded-lg font-semibold hover:border-accent hover:text-accent transition-all hover:scale-105"
        >
          View GitHub
        </a>
      </div>
