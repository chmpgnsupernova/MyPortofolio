...
const Hero = () => {
  const data = {
    ...
    desc: "Passionate tentang menciptakan web applications yang beautiful, responsive, dan user-friendly.",
    links: { 
  ...
  return (
    <section className="min-h-screen flex flex-col justify-center items-center text-center px-6 pt-20">
      ...
      <div className="flex items-center gap-2 bg-card border border-border px-4 py-2 rounded-full mb-8">
      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-12 w-full sm:w-auto">
        <a 
          ...
          className="flex items-center justify-center gap-2 bg-accent text-black px-6 py-3 rounded-lg font-bold hover:bg-green-400 transition-all hover:scale-105"
        >
          <Mail size={20} /> Contact Me
        </a>
        
        <a href={data.links.github} target="_blank" className="flex items-center justify-center gap-2 bg-transparent border border-border text-white px-6 py-3 rounded-lg font-semibold hover:border-accent hover:text-accent transition-all">
